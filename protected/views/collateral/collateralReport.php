...
/* @var $model Borrower */
$this->pageTitle=Yii::app()->name . ' - Collateral Listing Report';
$this->breadcrumbs=array(
  'Collateral_Report'=>array('collateralReport'),
  'Listing'=>array('collateralReport'),
);
    ...
    <div class="card">
        ...
        <div class="card-body">
				<div class="card-header">
					<h5 class="title">Collateral Listing</h5>
						...
						<?php $this->widget('bootstrap.widgets.TbGridView', array(
							...
							'columns'=>array(
								...
								array(
									...
									'name'=>'FormattedCollateralOriginalLoanAmount',
								),
								array(
									'header'=>'Current Bal',
									'name'=>'FormattedCollateralLoanCurrentBalance',
								),
								array(
...
<script type="text/javascript">
  $('#export-btn').click(function(){ 
	  $.fn.yiiGridView.update('collateral-grid', {
