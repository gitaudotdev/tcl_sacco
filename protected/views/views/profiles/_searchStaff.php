...
<div class="row">
  ...
  <br>
	<div class="row">
      ...
      <div class="col-md-3 col-lg-3 col-sm-12">
        <div class="form-group">
          <?=$form->dropDownList($model,'managerId',$model->getProfileManagersList(),array('prompt'=>'-- MANAGERS --','class'=>'selectpicker')); ?>
			...
			<div class="col-md-3 col-lg-3 col-sm-12">
        <div class="form-group">
        	<?=$form->dropDownList($model,'id',$model->getProfileManagersList(),array('prompt'=>'-- USER ACCOUNT --','class'=>'selectpicker'));?>
        </div>
      </div>
      <div class="col-md-3 col-lg-3 col-sm-12">
        <div class="form-group">
      ...
      <div class="col-md-3 col-lg-3 col-sm-12">
        <div class="form-group">
			    <?=CHtml::submitButton('Search Staff',array('class'=>'btn btn-primary','style'=>'margin-top:-2% !important;')); ?>
        </div>
      </div>
    </div>
    <br>
