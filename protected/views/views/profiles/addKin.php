<?php
$this->pageTitle=Yii::app()->name . ' - Add Profile Next Of Kin';
$this->breadcrumbs=array(
    'Profiles'=>array('admin'),
    'View'=>array('profiles/'.$model->id),
    'Add_Next_Of_Kin'=>array('profiles/addKin/'.$model->id),
);
/**Flash Messages**/
$successType = 'success';
...
<div class="row">
  <div class="col-md-12 col-lg-12 col-sm-12">
        <div class="card card-stats card-raised modified_card">
	        	<div class=" col-md-12 col-lg-12 col-sm-12">
		        	<h4 class="info-text" style="font-weight:bold;">&emsp;<?=$model->getProfileFullName();?> Profile: Next of Kin</h4>
                   ...
                   <div class="card-body col-md-12 col-lg-12 col-sm-12">
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group">
                                    <input type="submit" name="addProfileKinCmd" class="btn btn-primary pull-right" value="Create">
                                </div>
                            </div>
                        </div>
                        </div>
