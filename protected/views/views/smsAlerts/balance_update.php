<?php
$this->pageTitle=Yii::app()->name . ' -  Send Loan Account Balance';
$this->breadcrumbs=array(
	'Balance'=>array('balanceUpdate'),
	'Alerts'=>array('balanceUpdate')
);
/**Flash Messages**/
$successType = 'success';
      ...
      <?php endif;?>
        <div class="card-body">
          <div class="card-header">
              <h5 class="title">Loan Balances SMS</h5>
