...
$this->pageTitle=Yii::app()->name . ' - Overall Collections Performance Data Analytics and Statistics';
$this->breadcrumbs=array(
  'Dashboard'=>array('default'),
  'Analytics'=>array('overallCollectionPerformance'),
  'Overall_Collections_Performance'=>array('overallCollectionPerformance'),
);
?>
<div class="row">
  <div class="col-md-12 col-lg-12 col-sm-12">
        ...
        <div class="card card-stats card-raised-modified">
            <div class="card-body">
                <div class="row">
                  <div class="col-md-12 col-lg-12 col-sm-12">
                        <h4 class="info-title">Overall Collections Perfomance Statistics</h4>
                        <hr/>
                        <div class="loader" id="overallCollectionPerformanceGrowthTableLoader"></div>
                        <div id="loadOverallCollectionPerformanceGrowthTable" class="loaded-content"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-stats card-raised-modified">
            <div class="card-body">
                <div class="row">
                  <div class="col-md-12 col-lg-12 col-sm-12">
                        <h4 class="info-title">Overall Collections Performance Trend Graph</h4>
                        <hr/>
                        <div class="loader" id="overallCollectionPerformanceGrowthGraphLoader"></div>
                        <div id="loadOverallCollectionPerformanceGrowthGraph" class="loaded-content"></div>
                    </div>
                </div>
            </div>
        </div>
...
function loadAnalytics(){
  ...
  loadOverallCollectionPerformanceGrowthAnalytics(branch,staff,formattedStartDate,formattedEndDate);
  loadOverallCollectionPerformanceGrowthAnalyticsGraph(branch,staff,formattedStartDate,formattedEndDate);
}
...
function loadOverallCollectionPerformanceGrowthAnalytics(branch,staff,start_date,end_date){
  clearDivContent('loadOverallCollectionPerformanceGrowthTable');
  showLoader('overallCollectionPerformanceGrowthTableLoader',content);
  var dataString ='branch='+branch+'&staff='+staff+'&start_date='+start_date+'&end_date='+end_date;
  $.ajax({
    type:"POST",
    dataType:"json",
    url: "<?=Yii::app()->createUrl('dashboard/loadOverallCollectionPerformanceGrowthAnalytics');?>",
    data: dataString,
    success: function(response){
     hideLoader('overallCollectionPerformanceGrowthTableLoader');
     var message = 'Overall collections performance statistics fetched successfully ...';
     displayNotification(messagePanel,successType,message);
     $('#loadOverallCollectionPerformanceGrowthTable').html(response.tabulation);
    }
  });
  return false;
}

function loadOverallCollectionPerformanceGrowthAnalyticsGraph(branch,staff,start_date,end_date){
  clearDivContent('loadOverallCollectionPerformanceGrowthGraph');
  showLoader('overallCollectionPerformanceGrowthGraphLoader',content);
  var dataString ='branch='+branch+'&staff='+staff+'&start_date='+start_date+'&end_date='+end_date;
  $.ajax({
    type:"POST",
    url: "<?=Yii::app()->createUrl('dashboard/loadOverallCollectionPerformanceGrowthGraph');?>",
    data: dataString,
    success: function(graph){
     hideLoader('overallCollectionPerformanceGrowthGraphLoader');
     $('#loadOverallCollectionPerformanceGrowthGraph').html(graph);
    }
  });
  return false;
}
...
function initializeAnalytics(){
 var formattedStartDate  = formatDate(defaultStartDate);
 var formattedEndDate    = formatDate(defaultEndDate);
 loadOverallCollectionPerformanceGrowthAnalytics(defaultBranch,defaultStaff,formattedStartDate,formattedEndDate);
 loadOverallCollectionPerformanceGrowthAnalyticsGraph(defaultBranch,defaultStaff,formattedStartDate,formattedEndDate);
}
