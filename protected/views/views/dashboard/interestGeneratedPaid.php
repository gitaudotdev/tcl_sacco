...
$this->pageTitle=Yii::app()->name . ' - Interest Generated Vs Paid Data Analytics and Statistics';
$this->breadcrumbs=array(
  'Dashboard'=>array('default'),
  'Analytics'=>array('interestGeneratedPaid'),
  'Interest_Generated_Vs_Paid'=>array('interestGeneratedPaid'),
);
?>
<div class="row">
  <div class="col-md-12 col-lg-12 col-sm-12">
        ...
        <div class="card card-stats card-raised-modified">
            <div class="card-body">
                <div class="row">
                  <div class="col-md-12 col-lg-12 col-sm-12">
                        <h4 class="info-title">Interest Generated Vs Paid Statistics</h4>
                        <hr/>
                        <div class="loader" id="interestGeneratedPaidGrowthTableLoader"></div>
                        <div id="loadInterestGeneratedPaidGrowthTable" class="loaded-content"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-stats card-raised-modified">
            <div class="card-body">
                <div class="row">
                  <div class="col-md-12 col-lg-12 col-sm-12">
                        <h4 class="info-title">Interest Generated Vs Paid Trend Graph</h4>
                        <hr/>
                        <div class="loader" id="interestGeneratedPaidGrowthGraphLoader"></div>
                        <div id="loadInterestGeneratedPaidGrowthGraph" class="loaded-content"></div>
                    </div>
                </div>
            </div>
        </div>
...
function loadAnalytics(){
  ...
  loadInterestGeneratedPaidGrowthAnalytics(branch,staff,formattedStartDate,formattedEndDate);
  loadInterestGeneratedPaidGrowthAnalyticsGraph(branch,staff,formattedStartDate,formattedEndDate);
}
...
function loadInterestGeneratedPaidGrowthAnalytics(branch,staff,start_date,end_date){
  clearDivContent('loadInterestGeneratedPaidGrowthTable');
  showLoader('interestGeneratedPaidGrowthTableLoader',content);
  var dataString ='branch='+branch+'&staff='+staff+'&start_date='+start_date+'&end_date='+end_date;
  $.ajax({
    type:"POST",
    dataType:"json",
    url: "<?=Yii::app()->createUrl('dashboard/loadInterestGeneratedPaidGrowthAnalytics');?>",
    data: dataString,
    success: function(response){
     hideLoader('interestGeneratedPaidGrowthTableLoader');
     var message = 'Interests statistics fetched successfully ...';
     displayNotification(messagePanel,successType,message);
     $('#loadInterestGeneratedPaidGrowthTable').html(response.tabulation);
    }
  });
  return false;
}

function loadInterestGeneratedPaidGrowthAnalyticsGraph(branch,staff,start_date,end_date){
  clearDivContent('loadInterestGeneratedPaidGrowthGraph');
  showLoader('interestGeneratedPaidGrowthGraphLoader',content);
  var dataString ='branch='+branch+'&staff='+staff+'&start_date='+start_date+'&end_date='+end_date;
  $.ajax({
    type:"POST",
    url: "<?=Yii::app()->createUrl('dashboard/loadInterestGeneratedPaidGrowthGraph');?>",
    data: dataString,
    success: function(graph){
     hideLoader('interestGeneratedPaidGrowthGraphLoader');
     $('#loadInterestGeneratedPaidGrowthGraph').html(graph);
    }
  });
  return false;
}
...
function initializeAnalytics(){
 var formattedStartDate  = formatDate(defaultStartDate);
 var formattedEndDate    = formatDate(defaultEndDate);
 loadInterestGeneratedPaidGrowthAnalytics(defaultBranch,defaultStaff,formattedStartDate,formattedEndDate);
 loadInterestGeneratedPaidGrowthAnalyticsGraph(defaultBranch,defaultStaff,formattedStartDate,formattedEndDate);
}
