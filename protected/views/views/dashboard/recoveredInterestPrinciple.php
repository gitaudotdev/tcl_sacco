...
$this->pageTitle=Yii::app()->name . ' - Recovered Interests And Principles Data Analytics and Statistics';
$this->breadcrumbs=array(
  'Dashboard'=>array('default'),
  'Analytics'=>array('recoveredInterestPrinciple'),
  'Recovered_Interests_and_Principles'=>array('recoveredInterestPrinciple'),
);
?>
<div class="row">
  <div class="col-md-12 col-lg-12 col-sm-12">
        ...
        <div class="card card-stats card-raised-modified">
            <div class="card-body">
                <div class="row">
                  <div class="col-md-12 col-lg-12 col-sm-12">
                        <h4 class="info-title">Recovered Interests and Principles Statistics</h4>
                        <hr/>
                        <div class="loader" id="recoveredInterestPrincipleGrowthTableLoader"></div>
                        <div id="loadRecoveredInterestPrincipleGrowthTable" class="loaded-content"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-stats card-raised-modified">
            <div class="card-body">
                <div class="row">
                  <div class="col-md-12 col-lg-12 col-sm-12">
                        <h4 class="info-title">Recovered Interests and Principles Trend Graph</h4>
                        <hr/>
                        <div class="loader" id="recoveredInterestPrincipleGrowthGraphLoader"></div>
                        <div id="loadRecoveredInterestPrincipleGrowthGraph" class="loaded-content"></div>
                    </div>
                </div>
            </div>
        </div>
...
function loadAnalytics(){
  ...
  loadRecoveredInterestPrincipleGrowthAnalytics(branch,staff,formattedStartDate,formattedEndDate);
  loadRecoveredInterestPrincipleGrowthAnalyticsGraph(branch,staff,formattedStartDate,formattedEndDate);
}
...
function loadRecoveredInterestPrincipleGrowthAnalytics(branch,staff,start_date,end_date){
  clearDivContent('loadRecoveredInterestPrincipleGrowthTable');
  showLoader('recoveredInterestPrincipleGrowthTableLoader',content);
  var dataString ='branch='+branch+'&staff='+staff+'&start_date='+start_date+'&end_date='+end_date;
  $.ajax({
    type:"POST",
    dataType:"json",
    url: "<?=Yii::app()->createUrl('dashboard/loadRecoveredInterestPrincipleGrowthAnalytics');?>",
    data: dataString,
    success: function(response){
     hideLoader('recoveredInterestPrincipleGrowthTableLoader');
     var message = 'Recovered interests and principles statistics fetched successfully ...';
     displayNotification(messagePanel,successType,message);
     $('#loadRecoveredInterestPrincipleGrowthTable').html(response.tabulation);
    }
  });
  return false;
}

function loadRecoveredInterestPrincipleGrowthAnalyticsGraph(branch,staff,start_date,end_date){
  clearDivContent('loadRecoveredInterestPrincipleGrowthGraph');
  showLoader('recoveredInterestPrincipleGrowthGraphLoader',content);
  var dataString ='branch='+branch+'&staff='+staff+'&start_date='+start_date+'&end_date='+end_date;
  $.ajax({
    type:"POST",
    url: "<?=Yii::app()->createUrl('dashboard/loadRecoveredInterestPrincipleGrowthGraph');?>",
    data: dataString,
    success: function(graph){
     hideLoader('recoveredInterestPrincipleGrowthGraphLoader');
     $('#loadRecoveredInterestPrincipleGrowthGraph').html(graph);
    }
  });
  return false;
}
...
function initializeAnalytics(){
 var formattedStartDate  = formatDate(defaultStartDate);
 var formattedEndDate    = formatDate(defaultEndDate);
 loadRecoveredInterestPrincipleGrowthAnalytics(defaultBranch,defaultStaff,formattedStartDate,formattedEndDate);
 loadRecoveredInterestPrincipleGrowthAnalyticsGraph(defaultBranch,defaultStaff,formattedStartDate,formattedEndDate);
}
