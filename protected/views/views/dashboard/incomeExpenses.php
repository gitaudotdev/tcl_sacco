...
$this->pageTitle=Yii::app()->name . ' - Income and Expenses Data Analytics and Statistics';
$this->breadcrumbs=array(
  'Dashboard'=>array('default'),
  'Analytics'=>array('incomeExpenses'),
  'Income_and_Expenses'=>array('incomeExpenses'),
);
?>
<div class="row">
  <div class="col-md-12 col-lg-12 col-sm-12">
        ...
        <div class="card card-stats card-raised-modified">
            <div class="card-body">
                <div class="row">
                  <div class="col-md-12 col-lg-12 col-sm-12">
                        <h4 class="info-title">Income and Expenses Statistics</h4>
                        <hr/>
                        <div class="loader" id="incomeExpensesGrowthTableLoader"></div>
                        <div id="loadIncomeExpensesGrowthTable" class="loaded-content"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-stats card-raised-modified">
            <div class="card-body">
                <div class="row">
                  <div class="col-md-12 col-lg-12 col-sm-12">
                        <h4 class="info-title">Income and Expenses Graph</h4>
                        <hr/>
                        <div class="loader" id="incomeExpensesGrowthGraphLoader"></div>
                        <div id="loadIncomeExpensesGrowthGraph" class="loaded-content"></div>
                    </div>
                </div>
            </div>
        </div>
...
function loadAnalytics(){
  ...
  loadIncomeExpensesGrowthAnalytics(branch,staff,formattedStartDate,formattedEndDate);
  loadIncomeExpensesGrowthAnalyticsGraph(branch,staff,formattedStartDate,formattedEndDate);
}
...
function loadIncomeExpensesGrowthAnalytics(branch,staff,start_date,end_date){
  clearDivContent('loadIncomeExpensesGrowthTable');
  showLoader('incomeExpensesGrowthTableLoader',content);
  var dataString ='branch='+branch+'&staff='+staff+'&start_date='+start_date+'&end_date='+end_date;
  $.ajax({
    type:"POST",
    dataType:"json",
    url: "<?=Yii::app()->createUrl('dashboard/loadIncomeExpensesGrowthAnalytics');?>",
    data: dataString,
    success: function(response){
     hideLoader('incomeExpensesGrowthTableLoader');
     var message = 'Income and expenses statistics fetched successfully ...';
     displayNotification(messagePanel,successType,message);
     $('#loadIncomeExpensesGrowthTable').html(response.tabulation);
    }
  });
  return false;
}

function loadIncomeExpensesGrowthAnalyticsGraph(branch,staff,start_date,end_date){
  clearDivContent('loadIncomeExpensesGrowthGraph');
  showLoader('incomeExpensesGrowthGraphLoader',content);
  var dataString ='branch='+branch+'&staff='+staff+'&start_date='+start_date+'&end_date='+end_date;
  $.ajax({
    type:"POST",
    url: "<?=Yii::app()->createUrl('dashboard/loadIncomeExpensesGrowthGraph');?>",
    data: dataString,
    success: function(graph){
     hideLoader('incomeExpensesGrowthGraphLoader');
     $('#loadIncomeExpensesGrowthGraph').html(graph);
    }
  });
  return false;
}
...
function initializeAnalytics(){
 var formattedStartDate  = formatDate(defaultStartDate);
 var formattedEndDate    = formatDate(defaultEndDate);
 loadIncomeExpensesGrowthAnalytics(defaultBranch,defaultStaff,formattedStartDate,formattedEndDate);
 loadIncomeExpensesGrowthAnalyticsGraph(defaultBranch,defaultStaff,formattedStartDate,formattedEndDate);
}
