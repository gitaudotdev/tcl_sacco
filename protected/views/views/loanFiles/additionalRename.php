<?php
$this->pageTitle=Yii::app()->name . ' - Rename Uploaded Loan File';
$this->breadcrumbs=array(
	'Loanaccount'=>array('loanaccounts/'.$model->loanaccount_id),
	'File'=>array('loanFiles/additionalRename/'.$model->id),
  'Rename'=>array('loanFiles/additionalRename/'.$model->id),
);
?>
<div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-lg-3 col-sm-12">
                  <div class="form-group pull-right">
                    <a href="<?=Yii::app()->createUrl('loanaccounts/viewDetails'.$model->loanaccount_id);?>" class="btn btn-default">Cancel</a>
                  </div>
                </div>
              </div>
            </form>
