...
$this->breadcrumbs=array(
	...
	'Role'=>array('staff/reassign/'.$id),
	'Reassign'=>array('staff/reassign/'.$id)
);
/**Flash Messages**/
$successType = 'success';
  ...
  <div class="col-md-12 col-lg-12 col-sm-12">
    <div class="card">
        <div class="card-header">
  				<div class="col-md-12 col-lg-12 col-sm-12">
            <h5 class="title">Reassign Role</h5>
        ...
        <?php if($succesStatus === 1):?>
        	...
        	<div class="col-md-12 col-lg-12 col-sm-12">
        		...
        		<div class="col-md-12 col-lg-12 col-sm-12">
	        		<form method="post" action="<?=Yii::app()->createUrl('staff/commitReassignment');?>">
								...
								<div class="row">
									<div class="col-md-6 col-lg-6 col-sm-12">
										<div class="form-group">
											<input type="submit" class="btn btn-primary" value="Reassign" name="reassign_role_cmd">
										</div>
									</div>
									<div class="col-md-6 col-lg-6 col-sm-12">
										<div class="form-group">
