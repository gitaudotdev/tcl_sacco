<?php
$this->pageTitle=Yii::app()->name . ' - Reject Leave Request';
$this->breadcrumbs=array(
	'Requests'=>array('admin'),
  'Reject'=>array('leaveApplications/reject/'.$model->id)
);
?>
<div class="row">
  <div class="col-md-12">
    <div class="card">
        <div class="card-header">
          <div class="col-md-12 col-lg-12 col-sm-12">
            <h5 class="title">Reject Leave Request</h5>
          ...
          <div class="col-md-12 col-lg-12 col-sm-12">
                ...
                <div class="col-md-6 col-lg-6 col-sm-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-12">
                      <div class="form-group">
                        <input type="submit" name="auth_leave_cmd" class="btn btn-primary pull-right" value="Reject Request">
                      </div>
                    </div>
                  </div>
                  <br><br>
