<?php
$this->pageTitle=Yii::app()->name . ' - Accumulated Cash Flow';
$this->breadcrumbs=array(
  'Accumulated'=>array('accounting/cashflowaccumulated'),
	'CashFlow'=>array('accounting/cashflowaccumulated'),
);
?>
<style type="text/css">
	#cashflowaccumulated{
  ...
  <div class="col-md-12 col-lg-12 col-sm-12">
    <div class="card">
        <div class="card-header">
          <div class="col-md-12 col-lg-12 col-sm-12">
            <h5 class="title"> Accumulated Cash Flow</h5>
...
function GenerateCashFlowAccumulatedTable(branch,staff,startDate,endDate){
  ...
  $.ajax({
    type:"POST",
    url: "<?=Yii::app()->createUrl('accounting/loadCashFlowAccumulatedTable');?>",
    data: dataString,
    success: function(response){
