	...
	<div class="row">
		<div class="col-md-3 col-lg-3 col-sm-12">
			<div class="form-group">
				...
				<?=$form->textField($model,'user_employer',array('required'=>'required','maxlength'=>15,'class'=>'form-control','readonly'=>'readonly','id'=>'userEmployer')); ?>
			</div>
		</div>
		<div class="col-md-3 col-lg-3 col-sm-12">
			<div class="form-group">
				<label >Saving Account Balance</label>
				<?=$form->textField($model,'saving_balance',array('required'=>'required','maxlength'=>15,'class'=>'form-control','readonly'=>'readonly','id'=>'savingBalance')); ?>
			</div>
		</div>
	</div>
	<br>
