...
$this->pageTitle=Yii::app()->name . ' - Microfinance: Daily Collection Sheet';
$this->breadcrumbs=array(
	'Home'=>array('dashboard/admin'),
    'DailyCollectionSheet'=>array('loanaccounts/dailyCollection'),
);
/**Flash Messages**/
$successType = 'success';
  ...
  <div class="col-md-12 col-lg-12 col-sm-12">
    <div class="card">
        <div class="card-header">
			<div class="col-md-12 col-lg-12 col-sm-12">
	            <h5 class="title">Daily Collection Sheet</h5>
        ...
        <div class="card-body col-md-12 col-lg-12 col-sm-12">
        	<form style="margin:2% 0% 2% 0% !important;">
                <div class="row">
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-12" style="margin-top: -1.25% !important;">
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary" onclick="DailyCollectionSheet(event)"> <i class="now-ui-icons ui-1_zoom-bold"></i> 
                            View Sheet</button>
                        </div>
                    </div>
        	...
        	<div class="col-md-12 col-lg-12 col-sm-12">
        		...
        		<div id="loadDailyCollections"></div>
        	</div>
        </div>
    </div>
</div>
<script type="text/javascript">
    function DailyCollectionSheet(event){
      ...
      if(endDate >= startDate){
            ...
            $.ajax({
            type:"POST",
            url: "<?=Yii::app()->createUrl('loanaccounts/loadDailyCollectionSheet');?>",
            data: dataString,
            success: function(response){
                $('.loadingData').hide();
                if(response === 'NOT FOUND'){
                    $("#loadDailyCollections").html("<div class='col-md-8 col-lg-8 col-sm-8' style='padding:10px 10px 10px 10px !important;'><p style='border-bottom: 3px dotted #ddd;font-size:1.39em;color:#00933b;'><strong style='margin-left:20% !important;'>NO LOAN COLLECTIONS FOUND</strong></p><br><p style='color:#f90101;font-size:1.30em;'>*** NO COLLECTIONS FOUND BY THE SPECIFIED FILTERS. ****</p></div>");
                }else{
                    $('#loadDailyCollections').html(response).show().fadeIn('slow');
                }
            }
          });
          return false;
