...
$this->pageTitle=Yii::app()->name . ' - Microfinance : Loans Outstanding Principal Amount';
$this->breadcrumbs=array(
	'Home'=>array('dashboard/admin'),
    'OutstandingPrincipal'=>array('loanaccounts/principalOutstanding'),
);
/**Flash Messages**/
$successType = 'success';
    ...
    <div class="card">
        <div class="card-header">
			<div class="col-md-12 col-lg-12 col-sm-12">
	            <h5 class="title">Loans Outstanding Principal</h5>
                        ...
                        <?php if(!empty($loanaccounts)):?>
                            ...
                            <?php foreach($loanaccounts as $loanaccount):?> 
                                <tr>
                                    ...
                                    <td><?=CommonFunctions::asMoney(LoanRepayment::getTotalPrincipalPaid($loanaccount->loanaccount_id));?></td>
                                    <td><?=CommonFunctions::asMoney(LoanTransactionsFunctions::getLoanPrincipalBalance($loanaccount->loanaccount_id));?></td>
