<?php
$this->pageTitle=Yii::app()->name . ' - New Chama Loan Application';
$this->breadcrumbs=array(
	'Chama'=>array('chamas/view/'.$chama->id),
	'LoanApplication'=>array('chamas/applyLoan/'.$model->id)
);
?>
<div class="row">
        		...
        		<input type="hidden" name="user" value="<?=$model->id;?>">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-lg-2 col-sm-12">
                            <div class="form-group">
                                <a href="<?=Yii::app()->createUrl('chamas/view/'.$chama->id);?>" type="submit" class="btn btn-default">Cancel</a>
                            </div>
                        </div>
                        <div class="col-md-2 col-lg-2 col-sm-12">
                            <div class="form-group">
