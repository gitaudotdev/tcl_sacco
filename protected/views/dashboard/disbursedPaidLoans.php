...
$this->pageTitle=Yii::app()->name . ' - Disbursed Vs Paid Loans Data Analytics and Statistics';
$this->breadcrumbs=array(
  'Dashboard'=>array('default'),
  'Analytics'=>array('disbursedPaidLoans'),
  'Disbursed_Vs_Paid'=>array('disbursedPaidLoans'),
);
?>
<div class="row">
  <div class="col-md-12 col-lg-12 col-sm-12">
        ...
        <div class="card card-stats card-raised-modified">
            <div class="card-body">
                <div class="row">
                  <div class="col-md-12 col-lg-12 col-sm-12">
                        <h4 class="info-title">Disbursed Vs Paid Loans Statistics</h4>
                        <hr/>
                        <div class="loader" id="disbursedPaidLoansGrowthTableLoader"></div>
                        <div id="loadDisbursedPaidLoansGrowthTable" class="loaded-content"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-stats card-raised-modified">
            <div class="card-body">
                <div class="row">
                  <div class="col-md-12 col-lg-12 col-sm-12">
                        <h4 class="info-title">Disbursed Vs Paid Loans Trend Graph</h4>
                        <hr/>
                        <div class="loader" id="disbursedPaidLoansGrowthGraphLoader"></div>
                        <div id="loadDisbursedPaidLoansGrowthGraph" class="loaded-content"></div>
                    </div>
                </div>
            </div>
        </div>
...
function loadAnalytics(){
  ...
  loadDisbursedPaidLoansGrowthAnalytics(branch,staff,formattedStartDate,formattedEndDate);
  loadDisbursedPaidLoansGrowthAnalyticsGraph(branch,staff,formattedStartDate,formattedEndDate);
}
...
function loadDisbursedPaidLoansGrowthAnalytics(branch,staff,start_date,end_date){
  clearDivContent('loadDisbursedPaidLoansGrowthTable');
  showLoader('disbursedPaidLoansGrowthTableLoader',content);
  var dataString ='branch='+branch+'&staff='+staff+'&start_date='+start_date+'&end_date='+end_date;
  $.ajax({
    type:"POST",
    dataType:"json",
    url: "<?=Yii::app()->createUrl('dashboard/loadDisbursedPaidLoansGrowthAnalytics');?>",
    data: dataString,
    success: function(response){
     hideLoader('disbursedPaidLoansGrowthTableLoader');
     var message = 'Disbursed loans statistics fetched successfully ...';
     displayNotification(messagePanel,successType,message);
     $('#loadDisbursedPaidLoansGrowthTable').html(response.tabulation);
    }
  });
  return false;
}

function loadDisbursedPaidLoansGrowthAnalyticsGraph(branch,staff,start_date,end_date){
  clearDivContent('loadDisbursedPaidLoansGrowthGraph');
  showLoader('disbursedPaidLoansGrowthGraphLoader',content);
  var dataString ='branch='+branch+'&staff='+staff+'&start_date='+start_date+'&end_date='+end_date;
  $.ajax({
    type:"POST",
    url: "<?=Yii::app()->createUrl('dashboard/loadDisbursedPaidLoansGrowthGraph');?>",
    data: dataString,
    success: function(graph){
     hideLoader('disbursedPaidLoansGrowthGraphLoader');
     $('#loadDisbursedPaidLoansGrowthGraph').html(graph);
    }
  });
  return false;
}
...
function initializeAnalytics(){
 var formattedStartDate  = formatDate(defaultStartDate);
 var formattedEndDate    = formatDate(defaultEndDate);
 loadDisbursedPaidLoansGrowthAnalytics(defaultBranch,defaultStaff,formattedStartDate,formattedEndDate);
 loadDisbursedPaidLoansGrowthAnalyticsGraph(defaultBranch,defaultStaff,formattedStartDate,formattedEndDate);
}
