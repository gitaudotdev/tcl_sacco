...
$this->breadcrumbs=array(
	...
	'Pay'=>array('strayRepayments/savings/'.$model->id)
);
/**Flash Messages**/
$successType = 'success';
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="card-header">
              <h5 class="title">Pay To Saving Account</h5>
              <hr class="common_rule">
            </div>
        	<div class="col-md-12 col-lg-12 col-sm-12">
            <br>
            <form method="post" action="<?=Yii::app()->createUrl('strayRepayments/commitSavings');?>">
              ...
              <div class="row">
                <div class="col-md-8 col-lg-8 col-sm-12">
                  <div class="form-group">
                    <label style="margin-bottom: 5%!important;">Kindly select the valid saving account to pay to: </label>
                     <select name="savingaccount" class="selectpicker" required="required">
                      <option value="">--Select The Valid Saving Account--</option>
                      <?php
                      if(!empty($accounts)){
                        foreach($accounts as $account){
                          echo "<option value='";echo $account->savingaccount_id;echo"'>
                          $account->AccountDetails</option>";
                        }
                      }
                      ?>
                    </select>
