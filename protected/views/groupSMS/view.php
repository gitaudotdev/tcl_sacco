...
<?php
$this->pageTitle=Yii::app()->name . ' : Group SMS Details';
$this->breadcrumbs=array(
	'Group_SMS'  => array('admin'),
	'Details'    => array('groupSMS/'.$model->id)
);
/**Flash Messages**/
$successType = 'success';
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-header">
                  <h5 class="title">Group SMS Details</h5>
                  ...
                  <div class="col-md-12 col-lg-12 col-sm-12"><br>
                      ...
                      <div class="col-md-6 col-lg-6 col-sm-12">
					         ...
					         <table class="table table-condensed table-bordered">
								...
								<tbody>
									<?php $i=1;?>
									<?php foreach($groups as $chama):?>
										<tr>
											<td><?=$i;?></td>
											<td><?=$chama->ChamaName;?></td>
											<td><?=$chama->ChamaOrganization;?></td>
											<td><?=$chama->ChamaLocation;?></td>
											<td><?=$chama->GroupLeaderName;?></td>
											<td><?=$chama->GroupCollectorName;?></td>
										</tr>
										<?php $i++;?>
									<?php endforeach;?>
								</tbody>
							...
							<?php else:?>
							<h4>*** NO CHAMA ADDED FOR THE GROUP SMS ***</h4>
							<?php endif;?>
						</div>
              <div class="col-md-12 col-lg-12 col-sm-12">
                <br>
                ...
                <?php if(Navigation::checkIfAuthorized(286) === 1 && $model->status === 'SUBMITTED'):?>
                <div class="col-md-2 col-lg-2 col-sm-12">
                  <a href="#" class="btn btn-success pull-left" onclick="LoadApprove()">Approve</a>
                </div>
                <?php endif;?>
                <?php if(Navigation::checkIfAuthorized(287) === 1 && $model->status === 'SUBMITTED'):?>
                <div class="col-md-2 col-lg-2 col-sm-12">
