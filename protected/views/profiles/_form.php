		...
		<div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-12">
                <div class="form-group">
                    ...
                    <?=$form->dropDownList($model,'clientCategoryClass',array('SALARIED'=>'SALARIED','BUSINESS'=>'BUSINESS'),
                        array('prompt'=>'-- SELECT CATEGORY CLASS --','class'=>'selectpicker')); ?>
                    <?=$form->error($model,'clientCategoryClass'); ?>
                </div>
            </div>
