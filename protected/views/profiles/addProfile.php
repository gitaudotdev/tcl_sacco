                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-lg-3 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="clientCategoryClass" class="selectpicker form-control" required="required">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-3 col-lg-3 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="idNumber" class="form-control" placeholder="National ID#" required="required" minlength="6" maxlength="15" id="idNumber"/>
                                ...
                                <div class="col-md-3 col-lg-3 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lastName" class="form-control" required="required" placeholder="Middle & Last Names"/>
                                    </div>
                                </div>
                                </div>
                          <br/>
                          ...
                          <div class="row">
                                ...
                                <div class="col-md-3 col-lg-3 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phoneNumber" class="form-control" required="required" placeholder="Active Phone Number" minlength="9" maxlength="15" id="phoneNumber"/>
                                ...
                                <div class="col-md-3 col-lg-3 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username" class="form-control" placeholder="Client's Preferred Username" required="required" minlength="5" maxlength="50" id="username" />
                              ...
                              <div class="row">
                                <div class="col-md-3 col-lg-3 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" class="form-control" required="required" placeholder="Login Password" minlength="5" maxlength="12"/>
                                    </div>
                                </div>
                            </div>
