  ...
  <div class="col-md-12 col-lg-12 col-sm-12">
    <div class="card">
        <div class="card-header">
			<div class="col-md-12 col-lg-12 col-sm-12">
          <h5 class="title">Freezing Loan Penalty Accrual</h5>
        ...
        <div class="card-body col-md-12 col-lg-12 col-sm-12">
          <div class="col-md-12 col-lg-12 col-sm-12" style="margin:0% 0% 0.25% 0%!important;">
            ...
            <div class="col-sm-12 col-lg-12 col-md-12">
                  <br>
                  <hr>
                   <form method="post" action="<?=Yii::app()->createUrl('loanaccounts/CommitPenaltyFreezing');?>">
                   ...
                   <div class="row">
                      <div class="col-md-5 col-lg-5 col-sm-12">
                         <div class="form-group">
                          <label style="margin-bottom: 5% !important;">Reason for Freezing Penalty Accrual</label>
                  ...
                  <div class="row">
                      <div class="col-md-12 col-lg-12 col-sm-12">
                       <div class="form-group">
                        <input type="submit" class="btn btn-primary " value="Freeze Penalty">
