...
<!--                            </tr>-->
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-12">
                        <table class="table table-bordered table-hover table-responsive">
                            <tr>
                                <td><div class="text-wrap">Amount Applied</div></td>
                                <td><div class="text-wrap"><?=CommonFunctions::asMoney($model->amount_applied);?></div></td>
                            </tr>
                            <tr>
                                <td><div class="text-wrap">Amount Approved</div></td>
                                <td><div class="text-wrap"><?=CommonFunctions::asMoney($model->amount_receivable);?></div></td>
                            </tr>
                            <tr>
                                <td><div class="text-wrap">Insurance Fee</div></td>
                                <td><div class="text-wrap"><?=CommonFunctions::asMoney($model->insurance_fee);?></div></td>
                            </tr>
                            <tr>
                                <td><div class="text-wrap">Processing Fee</div></td>
                                <td><div class="text-wrap"><?=CommonFunctions::asMoney($model->processing_fee);?></div></td>
                            </tr>
                            <tr>
                                <td><div class="text-wrap">Total Deductions</div></td>
                                <td><div class="text-wrap"><?=CommonFunctions::asMoney($model->deduction_fee);?></div></td>
                            </tr>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-lg-8 col-sm-12">
                            <div class="form-group">
                                <label style="color: maroon">MPESA Amount To Client</label>
                                <!--                          <input type="text" class="form-control" required="required" value="--><?php //=$model->amount_approved;?><!--" name="amount_approved" readonly="readonly">-->
                        ...
                        <div class="col-md-8 col-lg-8 col-sm-12">
                            <div class="form-group">
                                <!--                          <label>Amount Approved less deductions</label>-->
                                <label style="color: darkgreen">Processed Amount</label>
                                <!--                          <input type="text" class="form-control" required="required" value="--><?php //=$model->amount_approved;?><!--" name="amount_approved" readonly="readonly">-->
                                <input type="text" class="form-control" required="required" value="<?= $model->amount_receivable;?>" name="amount_receivable" readonly="readonly">
