...
$this->pageTitle=Yii::app()->name . ' - Microfinance : Unfreeze Loan Application Interest Accrual';
$this->breadcrumbs=array(
  'Home'=>array('dashboard/admin'),
    'Applications'=>array('loanaccounts/admin'),
    'Unfreeze_Interest_Accrual'
);
/**Flash Messages**/
$successType = 'success';
...
<div class="row">
  <div class="col-md-12 col-lg-12 col-sm-12">
    <div class="card">
      ...
      <div class="col-md-12 col-lg-12 col-sm-12">
          <h5 class="title">Unfreeze Loan Interest Accrual</h5>
        ...
        <div class="card-body col-md-12 col-lg-12 col-sm-12">
          <div class="col-md-12 col-lg-12 col-sm-12" style="margin:0% 0% 0.25% 0%!important;">
            ...
            <div class="col-sm-12 col-lg-12 col-md-12">
                  <br>
                  <hr class="common_rule">
                   <form method="post" action="<?=Yii::app()->createUrl('loanaccounts/CommitUnfreezing');?>">
                    <input type="hidden" name="loanaccount_id" value="<?=$model->loanaccount_id;?>">
                    <div class="row">
                      <div class="col-md-12 col-lg-12 col-sm-12">
                         <div class="form-group">
                          <label style="margin-bottom: 5% !important;">Reason for Unfreezing Interest Accrual</label>
                          <textarea class="form-control" cols="5" rows="3" name="reason" placeholder="Brief Comment ..." required="required"></textarea>
                        </div>
                      </div>
                  </div>
                  <br>
                  <div class="row">
                      <div class="col-md-12 col-lg-12 col-sm-12">
                       <div class="form-group">
                        <input type="submit" class="btn btn-primary " value="Unfreeze Interest">
