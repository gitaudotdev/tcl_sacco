...
class EmploymentsController extends Controller{
	 ...
	 * @return Employments the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id){
		$model=Employments::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Employments $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='employments-form')
		{
