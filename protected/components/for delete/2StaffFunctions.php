...
class StaffFunctions{
    ...
    public static function getTotalPSalesValue($user_id,$month_date){
        return SalesManager::getProfilePSalesValue($user_id,$month_date);
    }

    public static function getTotalPSalesComm($user_id,$month_date){
        return SalesManager::getProfilePSalesComm($user_id,$month_date);
    }

    public static function getTotalPSalesBonus($user_id,$month_date){
        return SalesManager::getProfilePSalesBonus($user_id,$month_date);
    }
    ...
    public static function getMemberNetSalaryPay($user_id,$month_date){
        ...
        //$pSalesValue   = StaffFunctions::getTotalPSalesValue($user_id,$month_date);
        $pSalesValue   = 0;
        $pSalesComm    = StaffFunctions::getTotalPSalesComm($user_id,$month_date);
        $pSalesBonus   = StaffFunctions::getTotalPSalesBonus($user_id,$month_date);
        ...
        $totalnetPay       = ($monthlySalary + $pSalesValue + $pSalesComm + $pSalesBonus + $accruedBonus + $accruedCommission + $accruedProfit) - $loanRepayment;
        return $totalnetPay<= 0 ? 0: floor($totalnetPay);
    }
    /*************************
    ...
    public static function transferStaffAccount($staffID,$newUserID){
        ...
        if(!empty($newUser)){
            $newBranchID=$newUser->branchId;
            $userFullName=$newUser->getProfileFullName();
